...
<div align="center">
  <img src="docs/output.png" width="800" alt="Пример работы: исходная схема, предсказанная маска, итоговая сетка и RGB‑матрица"/>
  <br>
...
Для обучения и валидации собран датасет из **70 размеченных изображений** схем для вышивки крестиком:
- **Train:** 56 схем (80%)
- **Validation:** 14 схем (20%)

Каждое изображение размечено вручную: создана бинарная маска линий сетки. Имена масок соответствуют формату `{имя}_mask.png`.

<div align="center">
  <img src="docs/dataset.png" width="800" alt="Примеры изображений из датасета"/>
  <br>
  <sub>Примеры изображений из датасета</sub>
</div>
...
Обе модели были обучены на датасете из **70 размеченных схем** (56 train / 14 val) и сравнили их по метрикам IoU, Dice, Precision и Recall. **Лучшие результаты показал ResU‑Net:**
...
<div align="center">
  <img src="docs/teaser.png" width="700" alt="Визуализация сравнения моделей"/>
  <br>
...
- [GitHub](https://github.com/kicchhi/Research)
- [Overleaf](https://www.overleaf.com/read/pvxgbspjkpfr#43de76)
